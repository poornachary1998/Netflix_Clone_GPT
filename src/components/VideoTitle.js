const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-screen aspect-ratio-video pt-[19%] px-12 text-white absolute bg-gradient-to-right-from black">
      <h1 className="text-5xl font-bold">{title}</h1>
      <p className="py-3 text-lg w-1/3 mt-5">{overview}</p>
      <div className="p-2">
